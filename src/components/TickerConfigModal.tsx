        ...
        >
            <div className="px-5 pb-2 flex items-center justify-between text-xs text-zinc-400">
                ...
                <div className="flex gap-2">
                    <button onClick={selectAll} className="px-2 py-1 bg-zinc-800 hover:bg-zinc-700 rounded text-[0.6875rem] font-semibold">
                        {t.tickerConfig?.selectAll || 'Select all'}
                    </button>
                    <button onClick={clearAll} className="px-2 py-1 bg-zinc-800 hover:bg-zinc-700 rounded text-[0.6875rem] font-semibold">
            ...
            <div className="flex-1 overflow-y-auto px-5 py-3 space-y-4">
                {Object.entries(grouped).map(([category, items]) => (
                    <div key={category}>
                        <div className="text-[0.625rem] font-mono uppercase tracking-widest text-zinc-500 mb-2">
