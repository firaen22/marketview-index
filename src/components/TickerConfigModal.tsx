...
export function TickerConfigModal({ allSymbols, selected, language, t, onClose, onSave }: Props) {
    ...
    return (
        <div className="fixed inset-0 z-[110] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in duration-200">
            <Card className="w-full max-w-lg max-h-[80vh] flex flex-col border-zinc-700 bg-zinc-900 shadow-2xl overflow-hidden relative">
                ...
                <div className="flex justify-between items-center p-5 pb-3">
                    <h3 className="text-lg font-bold flex items-center">
                        ...
                        {t.tickerConfig?.title || 'Header Ticker'}
                    </h3>
                ...
                <div className="flex gap-3 p-5 pt-3 border-t border-zinc-800">
                    <button
                        onClick={save}
