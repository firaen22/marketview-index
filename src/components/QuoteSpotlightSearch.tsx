...
export function QuoteSpotlightSearch({ items, onCommit, onClose }: Props) {
    ...
    return (
        ...
        >
            ...
            >
                ...
                <div className="flex items-center gap-4 px-5 py-2 text-[10px] font-mono text-zinc-600 border-t border-zinc-900">
                    <span><kbd className="text-emerald-500">↑↓</kbd> select</span>
                    <span><kbd className="text-emerald-500">↵</kbd> commit</span>
                    <span><kbd className="text-emerald-500">Esc</kbd> close</span>
                </div>
            </div>
        </div>
    );
