...
const INDICES_TO_FETCH = [
  ...
  { symbol: 'XLK', category: 'US', subCategory: 'Sector', name: 'Technology' },
  { symbol: 'XLF', category: 'US', subCategory: 'Sector', name: 'Financials' },
  { symbol: 'XLV', category: 'US', subCategory: 'Sector', name: 'Health Care' },
  { symbol: 'XLY', category: 'US', subCategory: 'Sector', name: 'Consumer Disc' },
  { symbol: 'XLI', category: 'US', subCategory: 'Sector', name: 'Industrials' },
  { symbol: 'XLC', category: 'US', subCategory: 'Sector', name: 'Communication' },
  { symbol: 'XLP', category: 'US', subCategory: 'Sector', name: 'Consumer Staples' },
  { symbol: 'XLE', category: 'US', subCategory: 'Sector', name: 'Energy' },
  { symbol: 'XLU', category: 'US', subCategory: 'Sector', name: 'Utilities' },
  { symbol: 'XLRE', category: 'US', subCategory: 'Sector', name: 'Real Estate' },
  { symbol: 'XLB', category: 'US', subCategory: 'Sector', name: 'Materials' },
  {
    symbol: '0P00000EBQ',
    category: 'Fund',
